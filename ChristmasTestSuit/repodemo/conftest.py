...
from ChristmasTestSuit.repodemo.histories_project.POM.Pages.HomePage import HomePage
from ChristmasTestSuit.repodemo.histories_project.POM.Pages.ChristmasStart import ChristmasStart
from ChristmasTestSuit.repodemo.histories_project.POM.Pages.SaturnaliaCristmas import SaturnaliaChristmas
...
def get_driver(request, get_browser):
    ...
    request.cls.christmasstart = ChristmasStart(driver)
    request.cls.saturnaliachristmas = SaturnaliaChristmas(driver)
    request.cls.helpers = Helpers(driver)
